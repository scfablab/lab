***********************************************************************
　　Roland CAMM-1 DRIVER for Windows(R) 7 (64ビット版) 
***********************************************************************

最初にお読みください。インストールの手順が書かれています。
本書では、Windows 7 の基本的な操作方法についてすでにご理解いただいているものとして説明しています。
...
このドライバは、日本語 Windows 7 64ビット版 で動作する、当社製サインメーカーCAMM-1シリーズ用のドライバです。
