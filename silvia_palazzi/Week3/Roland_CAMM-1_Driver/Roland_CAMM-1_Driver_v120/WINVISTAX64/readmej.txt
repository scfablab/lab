***********************************************************************
　　Roland CAMM-1 DRIVER for Windows(R) Vista (64ビット版)
***********************************************************************
...
このドライバは、日本語 Windows Vista 64ビット版 で動作する、当社製サインメーカーCAMM-1シリーズ用のドライバです。
...
注意：
ダウンロードしたドライバーーのインストール手順です。
機器に付属するディスクからインストールするときは、その起動メニューからドライバーーのインストールをクリックしてください。
...
5. 「SETUP64.EXE」を選択して[開く]をクリックしたあと、[OK]をクリックします。
...
8. 「SETUP64.EXE」を選択して[開く]をクリックしたあと、[OK]をクリックします。
