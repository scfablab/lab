***********************************************************************
   Roland CAMM-1 DRIVER for Windows(R) Vista 64-bit
***********************************************************************
...
Copyright (C) 2009 - 2014 Roland DG Corporation
...
5.	Select "SETUP64.EXE" and click [Open], then click [OK].
...
8.	Select "SETUP64.EXE" and click [Open], then click [OK].
...
- At the [Layout]-[Page Setup] screen, [Set From Printer] (or [Get Page Size From Printer]) is updated with driver-specified cutting-range lengths of up to 3,276.7 mm.
